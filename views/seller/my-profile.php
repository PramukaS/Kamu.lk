...
<body>
    ...
    <div class="content">
        <div class="food-form form-container">
            <h2 style="text-transform: capitalize;text-align:center;">My_Profile</h2><br>
            <form class="form" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" step=0.1 name="name" size="50" value="" placeholder="759" disabled><br>
                    <label>Store Name</label><a onclick="myFunction()" href="javascript:void(0);" style="float:right;" value="1">Edit</a>
                    <input id="username" class="form-control" type="text" name="username" size="50" value="" autocomplete="off" placeholder="Mathara bath kade " disabled><br>

                    <div id="myDIV" style="display:none;">
                        <label>New Username</label>
                        <input id="hidden" class="form-control" type="text" name="username" size="50" value="" placeholder="Enter your New Username" required><br>
                    ...
                    <input class="form-control" type="password" name="password" size="3" value="" placeholder="42,kohuwala" disabled><br>

                    <div id="myDIV1" style="display:none;">
                        <label>New Password</label>
                        <input id="hidden" class="form-control" type="password" name="password" size="50" value="" placeholder="Enter your New Pssword" required><br>
                        <label>Re enter Password</label>
                        <input id="hidden" class="form-control" type="password" name="password" size="50" value="" placeholder="Re Enter New Pssword" required><br>
                        <input class="button" type="submit" name='submit2' value="Submit" size="25">
                    </div>

                    <div id="myDIV" style="display:none;">
                        <label>New Username</label>
                        <input id="hidden" class="form-control" type="text" name="username" size="50" value="" placeholder="Enter your New Username" disabled><br>
                    </div>


                    <label>Seller Name</label><a onclick="myFunction1()" href="javascript:void(0);" style="float:right;">Edit</a>
                    <input class="form-control" type="text" step=0.1 name="name" size="50" value="" placeholder="Pathmika Weerarathna" disabled><br>
                    <label>Contact Number</label><a onclick="myFunction1()" href="javascript:void(0);" style="float:right;">Edit</a>
                    <input class="form-control" type="number" name="cno" size="10" value="" placeholder="0773456467" disabled><br>
                    <label>E-mail</label><a onclick="myFunction1()" href="javascript:void(0);" style="float:right;">Edit</a>
                    <input class="form-control" type="number" name="cno" size="10" value="" placeholder="mathraba@gmail.com" disabled><br>
